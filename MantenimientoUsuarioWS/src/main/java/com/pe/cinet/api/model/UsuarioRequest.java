...
public class UsuarioRequest {
	...
	public double getCinet_creditos() {
		return cinet_creditos;
	}

	public void setCinet_creditos(double cinet_creditos) {
		this.cinet_creditos = cinet_creditos;
	}
